...
export const cadastroSchema = yup.object().shape(
    {
        ...
        termos: yup.boolean().oneOf([true], "É necessário aceitar o termo para continuar."),

        aceite_whatsapp: yup.boolean().oneOf([true], "É necessário aceitar o termo para continuar."),
    }
);
