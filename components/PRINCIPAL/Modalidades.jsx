    ...
    return(
        <section className="bg-slate-50 poppins">
            ...
            <div className='hidden lg:block'>
                <div className="px-5 lg:px-24 grid grid-cols-1 md:grid-cols-4 relative -top-5 md:-top-20">
                    {/*Energia*/}
                    <CardMod>
            ...
            <div className='poppins grid lg:grid-cols-5 grid-cols-2 justify-items-stretch items-stretch px-5 lg:px-28 relative lg:bottom-10 bottom-32'>
                ...
                <div className='col-span-4 grid grid-cols-4 self-start mt-24 lg:order-2 order-1'>
                    ...
                    <h1 className="col-span-4 lg:pl-5 text-slate-400 font-bold tracking-tight lg:text-4xl text-3xl self-end text-center lg:text-left mb-6">
