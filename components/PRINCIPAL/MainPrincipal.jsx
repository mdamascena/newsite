    ...
    return (
        <main className="p-8 pt-32 md:px-16 lg:px-32 bgMainPrincipal">
            <section className="grid grid-cols-1 md:grid-cols-2 poppins">
                ...
                <div className="my-16">
                    <h1 className="text-[3.0rem] leading-[3.5rem] font-bold tracking-tight text-white"><span className="text-sky-400">Seu empréstimo ONLINE</span> com múltiplas opções de créditos</h1>
                    ...
                    <button className="bg-sky-700 rounded-2xl text-white py-3 px-16 mt-4 hover:bg-sky-800 duration-500">Simule aqui</button>
                </div>
