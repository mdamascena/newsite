        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="h-[60vh] lg:h-[80vh]">
                ...
                <div className="grid grid-cols-6 gap-3">
                    ...
                    <h5 className="col-span-6 text-slate-400 mb-5 font-light lg:text-md text-sm">Crie uma senha simples para você acessar a sua proposta e acompanhar a análise</h5>
                    ...
                    <h5 className="col-span-6 mb-2 mt-5 text-slate-400 font-light lg:text-md text-sm">Crie uma senha simples</h5>
