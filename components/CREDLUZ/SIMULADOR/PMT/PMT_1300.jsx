...
const Btn = tw.button`
    ...
    rounded-md
`
export default function PMT1300({setShowCalc}){
        ...
        <div className='p-1'>
            ...
            <div className='rounded-lg bg-white/25 text-md py-4 px-1 mx-1'>
                ...
                <div className="grid grid-cols-2 gap-1 mb-1">
                    <Btn id='pmt_1300_15'>15 X</Btn>
                    <Btn id='pmt_1300_16'>16 X</Btn>
                </div>

                <div className="grid grid-cols-2 gap-1 mb-1">
                    <Btn id='pmt_1300_18'>18 X</Btn>
                    <Btn id='pmt_1300_20'>20 X</Btn>
                </div>
