...
const Btn = tw.button`
    ...
    rounded-md
`
export default function PMT1500({setShowCalc}){
        ...
        <div className='p-1'>
            ...
            <div className='rounded-lg bg-white/25 text-md py-4 px-1 mx-1'>
                ...
                <div className="grid grid-cols-2 gap-1 mb-1">
                    <Btn id='pmt_1500_16'>16 X</Btn>
                    <Btn id='pmt_1500_18'>18 X</Btn>
                </div>

                <div className="grid grid-cols-2 gap-1 mb-1">
                    <Btn id='pmt_1500_20'>20 X</Btn>
                    <Btn id='pmt_1500_22'>22 X</Btn>
                </div>
