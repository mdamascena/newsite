        ...
        <section className='select-none'>
            ...
            <div className='container-custom'>
                ...
                <div className='hidden lg:block'>
                    ...
                    <div className='grid grid-cols-4 gap-2 relative bottom-24'>
                        <CardMod>
                            <div className="duration-300 grid grid-cols-4 w-[100%]">
                                <MdOutlineCake className="text-5xl ml-auto my-auto text-blue-600 bg-blue-200 group-hover:bg-blue-400 group-hover:text-blue-100 duration-300 p-2 rounded-full" />
                        ...
                        <CardMod>
                            <div className="duration-300 grid grid-cols-4 w-[100%]">
                                <HiOutlineBanknotes className="text-5xl ml-auto my-auto text-blue-600 bg-blue-200 group-hover:bg-blue-400 group-hover:text-blue-100 duration-300 p-2 rounded-full" />
                                <div className='col-span-3 mx-auto'>
                        ...
                        <CardMod>
                            <div className="duration-300 grid grid-cols-4 w-[100%]">
                                <RiLightbulbFlashLine className="text-5xl ml-auto my-auto text-blue-600 bg-blue-200 group-hover:bg-blue-400 group-hover:text-blue-100 duration-300 p-2 rounded-full" />
                                <div className='col-span-3 mx-auto'>
                                    <p className="text-lg font-semibold text-slate-400 group-hover:text-white">Empréstimo</p>
                        ...
                        <CardMod>
                            <div className="duration-300 grid grid-cols-4 w-[100%]">
                                <SiPix className="text-5xl ml-auto my-auto text-blue-600 bg-blue-200 group-hover:bg-blue-400 group-hover:text-blue-100 duration-300 p-2 rounded-full" />
                                <div className='col-span-3 mx-auto'>
