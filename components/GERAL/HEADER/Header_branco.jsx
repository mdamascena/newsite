...
export default function Header() {
    ...
    return (
        <header>
            <AlertI />
            <div id='menuBar' className={`${bgNavbar[0]} flex flex-row mt-2 z-50 backdrop-blur-md fixed py-2 px-[20px] rounded-[10px] left-0 right-0 items-center lg:mx-32 mx-4 bg-blue-600 duration-500`}>
