...
import { pagamentoPix, identificacaoSchema, resumo } from '../../../schema/schemaFgts';
...
const Step5 = dynamic(() => import('./ResumoFgts'));

const schemas = [cadastroSchema, identificacaoSchema, enderecoSchema, pagamentoPix, resumo ];
